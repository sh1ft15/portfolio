      ...
      <div className='flex flex-col justify-between lg:col-span-1 text-xl p-2'>
          <div>
              ...
              <div className='text-base my-4'>
                  ...
                  <div className='flex gap-1 my-1 items-center'>
                      <FeatherIcon icon='linkedin' size={16} className={'min-w-5'}></FeatherIcon>
                      <a href='https://www.linkedin.com/in/sharifuddin-omar/' className='flex-grow hover:text-blue-500' target="_blank">sharifuddin-omar</a>
                  </div>
